 ...
 */
declare function Reactive(target: any, context: { kind: string }): any;
 ...
 */
declare function Effect(target: any, context: { kind: string; addInitializer: (fn: () => void) => void }): void;
 ...
 * @param context The context of the field.
 */
declare function Computed(target: any, context: { kind: string; name: string; addInitializer: (fn: () => void) => void }): void;
 ...
 * @param context The context of the method.
 */
declare function Bound(target: any, context: { kind: string; name: string; addInitializer: (fn: () => void) => void }): void;

export { Bound, Computed, CustomElement, Effect, Inject, Reactive, Service, isObject };
